<footer class="footer">
    <div class="footer__grid">
        <div class="footer__contenido">
            <h2 class="footer__logo">&#60DevWebCamp /></h2>
            <p class="footer__texto">Conferencia para desarrolladores de todos los niveles, de manera presencial y en línea. ¡Reserva tus entradas ya mismo!</p>
        </div>
